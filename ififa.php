...
<div class="post">
        ...
        <p><img src="images/fifa.jpg" alt="" width="470" height="370" />
        <p><h2>Round(I)</h2></p><br>
    <h3> <p>*Only first round will be consisting of re-entries</p></h3>
     <h3> <p>*Players will be allowed to select their own squads</p></h3>
        <br><br>
         <p><h2>Round(II)</h2></p><br>
    <h3> <p>*Finalists will have a series of 3 matches</p></h3>
     <h3> <p>*Players can bring their own set of Joysticks,Keyboards,etc.</p></h3>
        ...
        <p>
           <h3> <a id="popup_link_8" href="#">click here to register for FIFA </a></h3>
        <div id="popup_8" class="popup">
            <p style="float:right;"><a class="popup_closebox" href="#"><img src="images/close.png" /></a></p>
            <table>
                <form action="ififa.php" method="get" enctype="multipart/form-data" >
                    <tr><td><?php print "Are you sure you want to register for FIFA?"?></td></tr>
                    <input name="event_id" type="hidden" value="9" />
                        ...
                        if (!$registration_check>0) {
                            $sql = mysql_query("INSERT INTO participation (user_id,event_id)
                             VALUES($user_id,$event_id)")
                                    or die (mysql_error());
                            $success_msg = '<font color="#009900">h3><you are successfully registered for FIFA.</h3></font>';

                        } else {
                            $error_msg = '<font color="#FF0000">you are already registered for FIFA</font>';
                        }
