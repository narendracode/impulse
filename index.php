...
<?php print"$logOptions"; ?>
    ...
    <FONT SIZE="4" FACE="courier" COLOR=blue><MARQUEE WIDTH=100% BEHAVIOR=ALTERNATE BGColor=yellow>Candidates can register on the spot as well..</MARQUEE></FONT>
                               <img src="images/pic1.jpg" alt="" width="470" height="232" />
         ...
         <div id="posts">
            ...
            <div class="post">
                    ...
                    <div class="description">
                        <p>
                        <h3><b>Each one of us has much more hidden inside us than we have a chance to explore .Unless we create an environment that enables us to discover the limits of our potential ,we will never know what we have inside of us..</b></h3>
                        <br><h3> -Professor Muhammad Yunus</h3><br> <br>

                        <br><h3> <b>Rungta College of Engineering and Technology,Bhilai(C.G.) proudly presents Impulse-2011, A National Level Event, the first event of its kind in the central India. It is, in other words, the search for the most talented and capable students in various fields of Engineeing .

                            From March 13th to 14th, Impulse 2011 will hold a series of competitions for Engineering Students, challenging them to formulate ideas for new technologies, creative designs of bots and many more that would tackle real challenges in India. The aim of the contest is to hunt for some of the most talented students of India.</h3></b><br>
                    </div> <br><br><br>
                    <img src="images/stake.png" height="100" width="500" />
