...
<div class="post">
				...
				<div class="description">
					<p><img src="images/quiz.jpg" alt="" width="470" height="370" /></p>
                                       <p> <h3>A quiz is a form of game or mind sport in which the players (as individuals or in teams) attempt to answer questions correctly. In some countries, a quiz is also a brief assessment used in education and similar fields to measure growth in knowledge, abilities, and/or skills.
                                        So here we presents a national level quiz competition in which you will get fun, general knowledge, and technical que. In this compition.
                                        </h3></p><br><br>
                                       <p><h2>Format</h2></p><br>
    <h3> <p><b></b>The compition. Will be in three rounds.</p>
        <p><b>1st round :-</b>is fun round in this we will ask you some funy and excitings que from the entertainment zone. Top scorer will go to next round.</p>
        <p><b>2nd round:-</b> is the general knowledge test round, in this round you will face with some g.k. questions .this round is a buzzer round . top  teams will be go to next level. </p>
        <p><b>3rd round:-</b>this the last and final round in this round we will check your technical knowledge, the top  teams will be in this round. The  general technical que.. This round is also a buzzer round. So top scorer will be the quiz master .</p>

         </h3><br><br>
        <p><h2>Rules</h2></p><br>
    <h3> <p><b>1. </b>This is a general quiz; questions will encompass all topics under the sun. </p>
        <p><b>2. </b>The team comprises of two members </p>
        <p><b>3. </b>Team members must have their college ID cards. </p>
        <p><b>4. </b> There will be a written preliminary round. </p>
        <p><b>5. </b>Selected  teams will make it to the stage finals.</p>
        <p><b>6. </b>In the event of a tie, the tie will be resolved in a tie breaker. So u wouldn’t
Have to share the prize with another team.
</p>
         ...
         <p>
         <h3>  <a id="popup_link_7" href="#">click here to register for Quizzter </a></h3>
            ...
            <div id="popup_7" class="popup">
                ...
                <table>
                    <form action="iquiz.php" method="get" enctype="multipart/form-data" >
                    <tr><td><?php print "Are you sure you want to register for Quizzter?"?></td></tr>
                             <input name="event_id" type="hidden" value="1" />

                    <tr><td> <input name="parse_var" type="hidden" value="quiz" />
...
if ($_GET['parse_var'] == "quiz"){
        ...
        if (!$registration_check>0){
             $sql = mysql_query("INSERT INTO participation (user_id,event_id)
                       ...
                       or die (mysql_error());
              $success_msg = '<font color="#009900">you are successfully registered for Quiz competition</font>';

        } else {
			$error_msg = '<font color="#FF0000">you are already registered for Quiz</font>';
		}
