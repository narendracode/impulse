...
<div class="post">
    ...
    <div class="description">
        <p><img src="images/paperpresentation.jpg" alt="" width="470" height="370" /></p><br>
...
<input type="submit" value="register for paperpresentation" onclick="alert('login to your account for event registration')" />
