	...
	if(checkValues($_REQUEST['value']))
	{
		...
		echo "INSERT INTO facebook_posts (post,f_name,userip,date_created) VALUES('".checkValues($_REQUEST['value'])."','Impulse','".$userip."','".strtotime(date("Y-m-d H:i:s"))."')";

		mysql_query("INSERT INTO facebook_posts (post,f_name,userip,date_created) VALUES('".checkValues($_REQUEST['value'])."','Impulse','".$userip."','".strtotime(date("Y-m-d H:i:s"))."')");
